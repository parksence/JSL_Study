...
public class noticeList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Notice_DTO> dtos = dao.getnoticeList2(selValue,txtValue);	
		request.setAttribute("notice_dtos", dtos);
...
//		String		url				= null;	
		...
		RequestDispatcher rdp = request.getRequestDispatcher("/news_notice/notice_r.jsp");
